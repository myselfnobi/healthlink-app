...
import { Copy, MapPin, Loader2, CheckCircle } from 'lucide-react';
...
const HospitalRegister = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.image) {
            setError('Please upload an image of the hospital front.');
            return;
        }
        ...
        // Context now returns code string on success, or object on failure
                    ...
                    <AuthLayout title="Registration Success!" showBack={false}>
                        <div className="flex-col items-center justify-center p-4" style={{ textAlign: 'center', gap: 'var(--spacing-lg)' }}>
                            <div style={{ backgroundColor: '#e8f5e9', padding: '20px', borderRadius: 'var(--radius-lg)', width: '100%' }}>
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: 'var(--primary-dark)', background: 'none', fontWeight: 'bold'
                                    }}
                                >
                            ...
                            <p style={{ color: 'var(--text-secondary)' }}>
                                Please save this code safely. You will need it to login along with your Master PIN.
                            </p>
                ...
                <div className="auth-card" style={{ maxWidth: '500px' }}>
                    <AuthLayout title="Hospital Registration" subtitle="Join the HealthLink network">
                        <form onSubmit={handleSubmit} className="flex-col" style={{ gap: '20px' }}>
                            ...
                            {/* Image Upload Block */}
                            <ImageUpload
                                label="Hospital Front View (Used for Profile)"
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '16px' }}>
                                ...
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <div style={{ height: '200px', marginBottom: '16px', borderRadius: '16px', overflow: 'hidden', border: '2px solid #e2e8f0' }}>
                                    ...
                                    {formData.location && (
                                        <div style={{
                                            ...
                                            borderRadius: '8px', fontSize: '13px', color: '#1e40af', border: '1px solid #bfdbfe',
                                            display: 'flex', gap: '8px'
                                        }}>
                                            <CheckCircle size={16} />
                                            <span><strong>Coordinates:</strong> {formData.location}</span>
                                        </div>
                                    )}
                                </div>
                            ...
                            <p style={{ textAlign: 'center', fontSize: '15px', color: '#1e293b', marginTop: '24px', fontWeight: '500' }}>
                                Already have an account? <span onClick={() => navigate('/login/hospital')} style={{ color: 'var(--primary-color)', fontWeight: '700', cursor: 'pointer', textDecoration: 'underline' }}>Login here</span>
                            </p>
                        </form>
                    </AuthLayout>
                </div>
